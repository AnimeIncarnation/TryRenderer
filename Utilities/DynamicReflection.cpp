...
//        template<typename T> static constexpr bool Is(T = {}) 
//        { 
...
//    { 
//        /*T value;*/ static constexpr bool has_value = false;
...
//
//    template<class Name, class T>
//    struct Attr : NamedValue<Name, T> { constexpr Attr(Name, T v) : NamedValue<Name, T>{ v } {} };
//
//    template<class Name> 
//    struct Attr<Name, void> : NamedValue<Name, void> { constexpr Attr(Name) {} };
//
//
...
//    struct FieldList :ElemList<Fs...> { constexpr FieldList(Fs...fs) :ElemList<Fs...>{ fs... } {} };
